...
if (heroHeading && !prefersReduceMotion && typeof gsap !== 'undefined') {
...
if (heroParagraph && typeof gsap !== 'undefined') {
  if (!prefersReduceMotion) {
    ...
    heroParagraph.style.transform = 'none';
  }
}
    ...
    const getFocusable = () => mobileNav ? mobileNav.querySelectorAll('button, a, [tabindex]:not([tabindex="-1"])') : [];
    ...
    if (canvas && !prefersReduceMotion) {
        ...
        if (!prefersReduceMotion && typeof ScrollTrigger !== 'undefined') {
          ScrollTrigger.create({
              trigger: '.features-section',
              start: 'top 80%',
              onEnter: () => { animateFeatureIcons(); },
              once: true
          });
        }
    ...
    if (!prefersReduceMotion && typeof gsap !== 'undefined') {
    ...
    if (animationContainer && !prefersReduceMotion) {
...
if (!prefersReduceMotion && typeof gsap !== 'undefined' && typeof ScrollTrigger !== 'undefined') {
...
if (!prefersReduceMotion && typeof gsap !== 'undefined') {
  personaCards.forEach((card, index) => {
    ...
    if (whyChooseUsAnimationContainer && !prefersReduceMotion) {
    ...
    if (clarityIcon && !prefersReduceMotion && typeof gsap !== 'undefined') {
        gsap.timeline({
            scrollTrigger: {
                trigger: clarityIcon,
                start: 'top 80%',
